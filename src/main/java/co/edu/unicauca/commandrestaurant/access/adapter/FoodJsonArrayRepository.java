...
public class FoodJsonArrayRepository implements IFoodJsonRepository{
    ...
    private void inicializar(){
        ...
        datos.add(new CryptFood(3, "Pollo Asado", FoodTypeEnum.CARNE));
        datos.add(new CryptFood(4, "Limonada", FoodTypeEnum.JUGO));
        datos.add(new CryptFood(5, "Tres Leches", FoodTypeEnum.POSTRE));
    }
    @Override
